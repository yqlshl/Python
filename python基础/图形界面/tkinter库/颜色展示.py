...
for color in colors.split('\n'):
    sp = color.split(' ')
    try:
        tkinter.Label(text=color, bg=sp[1]).grid(row=int(i/colcut),column=i%colcut,sticky=tkinter.W+tkinter.E+tkinter.N+tkinter.S)
    except:
        print('err',color)
        tkinter.Label(text='ERR'+color).grid(row=int(i/colcut),column=i%colcut,sticky=tkinter.W+tkinter.E+tkinter.N+tkinter.S)
    i += 1
root.mainloop()